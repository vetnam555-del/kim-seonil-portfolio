...
- `js/main.js`: 스크롤 인터랙션, 모바일 내비게이션, 대표 프로젝트 필터·확장, 카운터 애니메이션, 이메일 복사 기능
- `assets/`: 파비콘 및 공유 이미지

## 주요 섹션

- Hero: 핵심 포지셔닝 및 대표 성과
- 핵심 성과: 운영 규모, ROAS, 자동화 효과
- 대표 캠페인: 핵심 6개 우선 노출, 추가 5개 확장, 배경·전략·실행·성과 중심의 사례
- 경력: 회사별 역할과 책임 범위
- 역량과 도구: 매체 운영, 데이터 분석, 전략, 자동화 역량
- 운영 브랜드: 산업군별 캠페인 경험
- 소개 / 일하는 방식: 문제 진단부터 성과 검증까지의 접근법
- 수상 및 선정: 현업 성과와 주요 수상 이력
- 연락: 이메일 및 이력서 요청 동선
